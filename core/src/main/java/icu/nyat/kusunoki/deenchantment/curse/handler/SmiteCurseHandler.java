...
/**
 * Reduces outgoing damage when striking undead creatures.
 */
public final class SmiteCurseHandler extends AbstractCurseHandler {

    private final double reduceRate;

    public SmiteCurseHandler(final JavaPlugin plugin,
    ...
    public void onEntityAttack(final DeEntityAttackEvent event) {
        ...
        if (!EntityClassifications.isUndead(victim)) {
            return;
        }
