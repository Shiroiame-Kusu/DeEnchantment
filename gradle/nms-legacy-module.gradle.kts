...
val craftPackage = project.extra["craftPackage"] as String
...
val generateLegacyBridge by tasks.registering(Sync::class) {
    val templateDir = rootProject.layout.projectDirectory.dir("nms-templates/legacy")
    from(templateDir) {
        ...
        filter<ReplaceTokens>("tokens" to mapOf(
            ...
            "CRAFTBUKKIT_PACKAGE" to craftPackage,
...
tasks.withType<JavaCompile>().configureEach {
    dependsOn(generateLegacyBridge)
}
